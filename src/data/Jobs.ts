...
const workExperience: WorkExperience[] = [
    {
        ...
        location: "Irvine, CA",
        description: "Develop and maintain responsive web pages and evaluate AI integration opportunities for the company website.",
        goals: [
    ...
    },
    {
        ...
        location: "UC Irvine",
        description: "Planned and ran club hangouts and cultural events to bring Thai and Southeast Asian students together at UCI.",
        goals: [
    ...
    },
    {
        ...
        company: "Thai Culture Association",
        location: "UC Irvine",
        description: "Supported the annual Thai Culture Night for four years across backstage coordination, the cultural play, and Thai Market Night.",
        goals: [
    ...
    },
    {
        ...
        location: "Irvine, CA",
        description: "Led IT support operations for the division, managing endpoint systems, help desk tickets, and network infrastructure for 300+ end users.",
        goals: [
    ...
    },
    {
        ...
        description: "Designed and implemented responsive front-end features using TypeScript and React, translating Figma designs into functional interfaces.",
        goals: [
    ...
    },
    {
        ...
        location: "Irvine, CA",
        description: "Contributed to tensegrity structure simulation research by developing unit tests and optimizing computational algorithms in Python.",
        goals: [
    ...
    },
    {
        ...
        company: "UCI Division of Continuing Education",
        location: "Irvine, CA",
        description: "Provided technical support for instructors and managed event equipment setup and breakdown.",
        goals: [
    ...
    },
    {
        ...
        location: "Irvine, CA",
        description: "Provided one-on-one academic support for 300+ students in Python and C++ coursework during lab sessions.",
        goals: [
    ...
    },
    {
        ...
        location: "Irvine, CA",
        description: "Mentored incoming freshmen and coordinated events to foster academic success and community building at UCI.",
        goals: [
    ...
    },
    {
        ...
        location: "Irvine, CA",
        description: "Supported research operations including literature searches, data management, and grant preparation.",
        goals: [
